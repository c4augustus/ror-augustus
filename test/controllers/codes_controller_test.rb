...
class CodesControllerTest < ActionController::TestCase
  ...
  test "should create code" do
    assert_difference('Code.count') do
      post :create, code: { filename: @code.filename, language: @code.language, revision: @code.revision, revision_data: @code.revision_data, title: @code.title }
    end
  ...
  test "should update code" do
    patch :update, id: @code, code: { filename: @code.filename, language: @code.language, revision: @code.revision, revision_data: @code.revision_data, title: @code.title }
    assert_redirected_to code_path(assigns(:code))
  end
